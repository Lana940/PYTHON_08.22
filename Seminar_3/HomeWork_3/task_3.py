...
word = input('VVEDITE SLOVO CAPSLOCK-ом : ')
...
if word.isascii() and word.isalpha():
    ...
    print('Russian text')
    print(sum([k for i in word for k, v in russian.items() if i in v]))
...
d_English = {1:'AEIOULNSTR', 2:'DG', 3:'BCMP',
                 4:'FHVWY', 5:"K" , 8:'JX', 10:'QZ'}
d_Russian = {1:'АВЕИНОРСТ', 2:'ДКЛМПУ', 3:'БГЁЬЯ',
